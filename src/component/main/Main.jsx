...
const Main = () => {
  ...
  return (
    <div id='intro' className='flex box mt-[5%] w-[100%] h-auto bg-secondary'>
        ...
        <div className='w-[50%]  box1 '>
            ...
            <div className="flex">
      <div className="border-2  border-primary p-4 ml-6 typewriter rounded-[10px] bg-black">
        ...
        <span style={{ color: ' rgb(233 30 99 / var(--tw-border-opacity))', fontWeight: 'bold' }}>
          ...
          />
            ...
            <div className='ml-[17%] mt-10 w-[150px]'>
                <button className='w-[100%] h-[50px] bg-black text-[white] border-2 border-primary'>Contact Me</button>
            </div>
        </div>
